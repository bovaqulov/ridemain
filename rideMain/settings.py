"""
Django settings for rideMain project.
...
SECRET_KEY = "django-insecure-d0#@=jkh^%4dh96%%+b!j$#^6p^s-fg@@dze64mbh4in@*s0uf"
...
WSGI_APPLICATION = "rideMain.wsgi.application"
...
CSRF_TRUSTED_ORIGINS = [
    "https://ridemain-production.up.railway.app",
]
